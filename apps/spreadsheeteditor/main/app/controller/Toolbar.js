...
//            });
        ...
        onAppShowed: function (config) {
            ...
            if ( !config.isEditDiagram && !config.isEditMailMerge && !config.isEditOle ) {
                ...
                // my-custom todo: close collaboration
                if (false && $panel) {
            ...
            if ( config.isEdit ) {
                ...
                if ( !config.isEditDiagram && !config.isEditMailMerge && !config.isEditOle ) {
                    ...
                    // my-custom todo: close pivot
                    if (false && config.canFeaturePivot) {
