...
//                this.recognizeBrowser();
            ...
            loadConfig: function(data) {
                ...
                //my-custom todo: add canDesign options
                this.appOptions.isLockTitle = this.editorConfig.customization.locktitle;

                //my-custom todo: add global state to window
                window.accesstoken = this.editorConfig.accesstoken;
