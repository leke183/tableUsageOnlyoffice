    ...
    Common.Views.Header =  Backbone.View.extend(_.extend(function(){
        ...
        var templateRightBox = '<section>' +
                            ...
                            '<section style="display: inherit;">' +
                                ...
                                '</div>' +
                                '<div class="hedset" data-layout-name="header-users" style="display:none;">' +
                                    // '<span class="btn-slot text" id="slot-btn-users"></span>' +
                                    //my-custom todo: hidden user's menu
                                ...
                                '</div>' +
                                '<div class="hedset" style="display:none;">' +
                                    '<div class="btn-slot">' +
        ...
        var templateLeftBox = '<section class="logo">' +
                                '<div id="header-logo" style="display:none;"><i></i></div>' +
                            '</section>';
